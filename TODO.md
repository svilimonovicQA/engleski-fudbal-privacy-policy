...
- [x] Add modern visual system (colors, spacing, typography, shadows) in `index.html`
- [x] Wrap main content in a professional card-style layout
- [x] Improve language switcher styling and interaction states
